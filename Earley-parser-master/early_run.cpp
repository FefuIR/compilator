...
//правила
    ...
    gr.add_symbol_to_right_part_of_rule(
    ...
    gr.add_symbol_to_right_part_of_rule( Pr_6, "separator ;" );
    ...
    unsigned int Pr_9 = gr.add_rule( "Pr —> CondOp" );
    gr.add_left_nonterminal_to_rule(Pr_9, "Pr" );
    gr.add_symbol_to_right_part_of_rule( Pr_9, "VarDec" );
...
//Part3
    ...
    gr.add_symbol_to_right_part_of_rule( LoopOpStep_1, "type of data" );
...
///?????
    ...
    unsigned int ComplxOpConstr_22 = gr.add_rule( "ComplxOpConstr —> ExprAssign;" );
    gr.add_left_nonterminal_to_rule(ComplxOpConstr_22, "ComplxOpConstr" );
    gr.add_symbol_to_right_part_of_rule( ComplxOpConstr_22, "Pr" );
...
/////??????
    ...
    if( parser.parse(la) ){
        std::cout << "Алгоритм Эрли выполнен успешно\n";
        parser.print();
        parse_tree tree;
